...
impl<'info> Buy<'info> {
    pub fn send_sol(&mut self) -> Result<()> {
        ...
        msg!("Transferring {} lamports from taker {} to maker {}", maker_amount, self.taker.key(), self.maker.key());
        transfer(
            CpiContext::new(
    ...
    pub fn receive_nft(&mut self) -> Result<()> {
        ...
        msg!("Transferring NFT asset {} to taker {}", self.asset.key(), self.taker.key());
    ...
    pub fn receive_rewards(&mut self) -> Result<()> {
        ...
        msg!("Minting reward token to taker {}", self.taker.key());
        mint_to(
